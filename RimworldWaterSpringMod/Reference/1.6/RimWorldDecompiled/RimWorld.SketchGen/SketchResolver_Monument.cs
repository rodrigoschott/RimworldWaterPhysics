...
public class SketchResolver_Monument : SketchResolver
{
	...
	protected override void ResolveInt(SketchResolveParams parms)
	{
		...
		bool onlyBuildableByPlayer = parms.onlyBuildableByPlayer.GetValueOrDefault();
		...
		if (parms.addFloors ?? true)
		{
			...
			parms3.allowConcrete = parms.allowConcrete.GetValueOrDefault();
		...
		{
			num5 = (allowMonumentDoors.GetValueOrDefault() ? 1 : 0);
		}
		if (num5 != 0)
		{
			goto IL_06a9;
