...
public class SymbolResolver_Settlement : SymbolResolver
{
	...
	public override void Resolve(ResolveParams rp)
	{
		...
		if (!rp.settlementDontGeneratePawns.GetValueOrDefault())
		{
			Lord singlePawnLord = (rp.settlementLord = rp.singlePawnLord ?? LordMaker.MakeNewLord(faction, new LordJob_DefendBase(faction, rp.rect.CenterCell, 25000, rp.attackWhenPlayerBecameEnemy.GetValueOrDefault()), map));
