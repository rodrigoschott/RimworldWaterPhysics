...
public class SymbolResolver_SingleThing : SymbolResolver
{
	...
	public override void Resolve(ResolveParams rp)
	{
		...
		else
		{
			...
			{
				rot = Rot4.North;
				if (!TryFindSpawnCellForItem(rp.rect, out result, rp.spawnOutside.GetValueOrDefault()))
				{
			...
			{
				result = FindBestSpawnCellForNonItem(rp.rect, thingDef, ref rot, out var hasToWipeBuilding, out var doesntFit, rp.spawnOutside.GetValueOrDefault());
