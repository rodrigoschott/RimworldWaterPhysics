...
public static class GenTicks
{
	...
	public static int ConfiguredTicksAbsAtGameStart
	{
		get
		{
			...
			Twelfth twelfth = ((gameInitData.startingSeason != 0) ? gameInitData.startingSeason.GetFirstTwelfth(vector.y) : ((!gameInitData.startingTile.Valid) ? Season.Summer.GetFirstTwelfth(0f) : TwelfthUtility.FindStartingWarmTwelfth(gameInitData.startingTile)));
