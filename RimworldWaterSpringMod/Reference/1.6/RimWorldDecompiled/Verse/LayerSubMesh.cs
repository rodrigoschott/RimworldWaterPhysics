...
public class LayerSubMesh
{
	...
	public void Clear(MeshParts parts)
	{
		...
		if ((parts & MeshParts.UVs1) != 0)
		{
			uvs.Clear();
		}
		if ((parts & MeshParts.UVs2) != 0)
		{
			uvsChannelTwo.Clear();
		}
		if ((parts & MeshParts.Normals) != 0)
		{
			normals.Clear();
		}
		finalized = false;
	...
	public void FinalizeMesh(MeshParts parts)
	{
		...
		if ((parts & MeshParts.UVs1) != 0 && uvs.Count > 0)
		{
			mesh.SetUVs(0, uvs);
		}
		if ((parts & MeshParts.UVs2) != 0 && uvsChannelTwo.Count > 0)
		{
			mesh.SetUVs(1, uvsChannelTwo);
		}
		if ((parts & MeshParts.Normals) != 0 && normals.Count > 0)
		{
