...
public class GenStep_ScatterRuinsSimple : GenStep_Scatterer
{
	...
	protected override void ScatterAt(IntVec3 c, Map map, GenStepParams parms, int stackCount = 1)
	{
		...
		parms2.monumentSize = new IntVec2(cellRect.Width, cellRect.Height);
		parms2.destroyChanceExp = destroyChanceExp;
		RimWorld.SketchGen.SketchGen.Generate(SketchResolverDefOf.MonumentRuin, parms2).Spawn(map, cellRect.CenterCell, null, Sketch.SpawnPosType.Unchanged, Sketch.SpawnMode.Normal, wipeIfCollides: false, forceTerrainAffordance: false, clearEdificeWhereFloor: false, null, dormant: false, buildRoofsInstantly: false, delegate(SketchEntity entity, IntVec3 cell)
		{
