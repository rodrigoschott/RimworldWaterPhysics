...
public class CreditsAssembler
{
	public static IEnumerable<CreditsEntry> AllCredits()
	{
		...
		{
			yield return new CreditRecord_Title("Credits_Localization_Odyssey".Translate());
			yield return new CreditRecord_Title("Local Heroes Worldwide B.V.");
			yield return new CreditRecord_Role("Credits_LeadLocalizationProjectManager".Translate(), "Iris Kuppen");
			yield return new CreditRecord_Role("Credits_LocalizationProjectManager".Translate(), "Maikel Roelofs");
			yield return new CreditRecord_Title("Credits_Dutch".Translate() + ": The Translation Fource");
			yield return new CreditRecord_Role("Credits_Translator".Translate(), "Sandra Vos");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "René van Vemde");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "Maikel Roelofs");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "Sandra Vos");
			yield return new CreditRecord_Title("Credits_Russian".Translate() + ": Levsha");
			yield return new CreditRecord_Role("Credits_ProjectManager".Translate(), "Ekaterina Yamenskova");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "Nadezhda Lynova");
			yield return new CreditRecord_Title("Credits_Turkish".Translate() + ": Locpick");
			yield return new CreditRecord_Role("Credits_ProjectManager".Translate(), "Batuhan Öztürk");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "Bigem Gözen");
			yield return new CreditRecord_Title("Credits_Ukrainian".Translate() + ": Levsha");
			yield return new CreditRecord_Role("Credits_ProjectManager".Translate(), "Ekaterina Yamenskova");
			yield return new CreditRecord_Role("Credits_Translator".Translate(), "Vitalii Khrystiuk");
			yield return new CreditRecord_Role("Credits_Editor".Translate(), "Konstantin Kopin");
		}
